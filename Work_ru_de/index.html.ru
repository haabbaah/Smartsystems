...
<head>
	...
	<title>sm-art.systems - лаборатория интеграционных решений</title>
	<meta name="viewport"
	...
	<meta name="application-name" content="smart systems">
	<meta name="apple-mobile-web-app-title" content="smart systems">
	<meta name="theme-color" content="#3B3E49">
	<meta name="msapplication-navbutton-color" content="#3B3E49">
	<meta name="apple-mobile-web-app-status-bar-style" content="black-translucent">
	<meta name="msapplication-starturl" content="/https://sm-art.systems/">
	...
	<meta name="Description" content="Лаборатория интеграционных решений.">
...
<body>
	...
	<div class="blur-wrapper">
		...
		<section class="s-head">
			<div class="grid">
				<div class="wrapper-logo">
					<div class="logo">
						<img class="logo-img" src="img/logo_ru.svg" alt="logo">
						<h3>
							Сертифицированный партнер <span>Global&nbsp;Intellect&nbsp;Service&nbsp;<img src="img/global.png"
									alt=""></span>
						</h3>
					</div>
				</div>
		...
		<section class="s-ready">
			<div class="grid">
				<h2 class="zag-2">
					Разработанные нами решения для UDS:
				</h2>

				<div class="uds-service">
					<div class="uds-item">
						<img src="img/small-img/uds/01.png" class="lazy-load" alt="" data-src="img/uds/01.png">
						<h4>
							1С:Розница
						</h4>
					</div>
					...
					<div class="uds-item">
						<img src="img/small-img/uds/02.png" class="lazy-load" alt="" data-src="img/uds/02.png">
						<h4>
							r_keeper<br>
							<span>
								Версия 6<br>
					...
					<div class="uds-item">
						<img src="img/small-img/uds/03.png" class="lazy-load" alt="" data-src="img/uds/03.png">
						<h4>
							iiko<br>
							<span>
								Поддерживаемые версии&nbsp;ПО:<br>
								ОС - Windows[XPSP3; 8.1] (.NET 4.0), iiko – около 4.4.7.
							</span>
						</h4>
					</div>
					<div class="uds-item">
						<img src="img/small-img/uds/04.png" class="lazy-load" alt="" data-src="img/uds/04.png">
						<h4>
							Трактир<br>
							<span>
								Версия 4.0.92
					...
					<div class="uds-item">
						<img src="img/small-img/uds/05.png" class="lazy-load" alt="" data-src="img/uds/05.png">
						<h4>
							TillypadXL<br>
							<span>
								Требования: Win7 и выше, MSSQL 2012 и выше, TillypadXL v9.7
							</span>
						</h4>
					</div>
					<div class="uds-item">
						<img src="img/small-img/uds/06.png" class="lazy-load" alt="" data-src="img/uds/06.png">
						<h4>
							smartTouch
						</h4>
					</div>
					<div class="uds-item">
						<img src="img/small-img/uds/07.png" class="lazy-load" alt="" data-src="img/uds/07.png">
						<h4>
							JoomShopping
						</h4>
					</div>
					<div class="uds-item">
						<img src="img/small-img/uds/08.png" class="lazy-load" alt="" data-src="img/uds/08.png">
						<h4>
							МойСклад
						</h4>
					</div>
					<div class="uds-item">
						<img src="img/small-img/uds/09.png" class="lazy-load" alt="" data-src="img/uds/09.png">
						<h4>
							VirtueMart
						</h4>
					</div>
		...
		<footer>
			<h3>
				© ООО «Смарт-Системс», 2017-<span class="footer-year"></span>
			</h3>
		</footer>
